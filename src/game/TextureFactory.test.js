...
import { TextureFactory, TEXTURE_NAMES, BAKED_PATH, PBR_SETS, CLOTH_FOLDS, BEDROCK, clothFoldsHeight, heightToNormal, bedrockHeight, bedrockPixels } from './TextureFactory.js';
